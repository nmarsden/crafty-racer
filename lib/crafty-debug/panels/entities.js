(function(){
    ...
    $(document).on('click', '#crafty-debug #entities-box .list ul li a', function(){
        Crafty.debugBar.renders.renderEntityDetails(Crafty($(this).data('ent')));
    });

    $(document).on('click', '#crafty-debug #entities-box .components ul li a.remove', function(){
    ...
    $(document).on('click', '#crafty-debug #entities-box .components .addComponent', function(){
        Crafty.debugBar.utils.addEntityComponent(this);
    });

    $(document).on('keypress', '#crafty-debug #entities-box .components input.search', function(event) {
        if ( event.which == 13 ) {
    ...
    $(document).on('keyup', '#crafty-debug #entities-box .properties .content input', function(){
    ...
    /* Options mangement */
    $(document).on('click', '#crafty-debug #entities-box .options .visible', function(){
    ...
    $(document).on('click', '#crafty-debug #entities-box .options .draggable', function(){
        var id = $(this).parent().data('ent'),
            entity = Crafty(id),
            btn = $(this);
    ...
    $(document).on('click', '#crafty-debug #entities-box .options .hitBox', function(){
        var id = $(this).parent().data('ent'),
            entity = Crafty(id),
            btn = $(this);
    ...
    $(document).on('click', '#crafty-debug #entities-box .options .console', function(){
        var entity = $(this).parent().data('ent');
        console.log(Crafty(entity));
    });

    $(document).on('click', '#crafty-debug #entities-box .options .remove', function(){
        var entity = $(this).parent().data('ent');
